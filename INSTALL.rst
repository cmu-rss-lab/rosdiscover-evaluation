...
Additionally, to check architectural rules with acme, a java installation is required. See https://www.java.com/en/download/help/download_options.html. Please ensure that java is added to the path. 
